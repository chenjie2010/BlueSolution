...
{
    public partial class RoleItemsForm : Form
    {
        #region 属性
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            {
                NodeSelected(roleDropdownList.SelectedNode);
            }
            this.Close();
        }
