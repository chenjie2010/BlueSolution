...
namespace Blue.WindowsFormsClient
{
    ...
    /// 下拉选择项操作类
    /// </summary>
    public class TreeSelectedItems : CombinedTreeDropdownBase, ITreeDropdownHandler
    {
        #region 契约属性
        ...
        /// 叶子节点契约
        /// </summary>
        public ICommonNodeContract NodeContract
        {
            get;
            set;
        }
        ...
        /// <param name="nodeContract"></param>
        public TreeSelectedItems(ICustomGroupContract customGroupContract, ICommonNodeContract nodeContract)
            : this(customGroupContract, nodeContract, decimal.MinValue)
        {
        ...
        public TreeSelectedItems(ICustomGroupContract customGroupContract, ICommonNodeContract nodeContract, decimal rootNodeId)
            : base(customGroupContract, nodeContract, decimal.MinValue, (byte)GroupType.CombinedTable, false)
        {
        ...
        protected override void SetCommonNodeContract(CombinedNodeType combinedNodeType)
        {
            ...
            switch (combinedNodeType)
            {
                ...
                case CombinedNodeType.Leaf:
                    CommonNodeContract = NodeContract;
                    break;
