...
{
    public partial class DataFillItemsForm : Form
    {
        ...
        {
            dataFillDropdownList.CustomGroupContract = customGroupContract;
            dataFillDropdownList.CustomDataContract = customDataContract;
            dataFillDropdownList.InitCommonNodeContract(customGroupContract);
            dataFillDropdownList.LoadData();
        }
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            {
                NodeSelected(dataFillDropdownList.SelectedNode);
            }
            this.Close();
        }
        ...
        private void treeDropdownList_OnNodeRemoved(object sender, EventArgs e)
        {
            ...
            dataFillDropdownList.Value = null;
        }
