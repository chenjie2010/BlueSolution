...
{
    public partial class ReportItemsForm : Form
    {
        ...
        public ReportCategory ReportCategory
        {
            get
            {
                return reportDropdownList.ReportCategory;
            }
            set
            {
                reportDropdownList.ReportCategory = value;
            }
        }
        ...
        {
            reportDropdownList.CustomGroupContract = customGroupContract;
            reportDropdownList.CustomReportContract = customReportContract;
            reportDropdownList.InitCommonNodeContract(customGroupContract);
            reportDropdownList.LoadData();
        }
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            {
                NodeSelected(reportDropdownList.SelectedNode);
            }
            this.Close();
        }
