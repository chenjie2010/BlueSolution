...
{
    public partial class DataFieldRelationForm : Form
    {
        #region 私有变量
        ...
        /// <param name="e"></param>
        private void DataFeildRelationForm_Load(object sender, EventArgs e)
        {
        ...
        private IList<CommonNode> GetDataFields()
        {
            ...
            //FormType tableType = (FormType)CurrentCustomQueyInfo.DataQueriedType;
            //switch (tableType)
            //{
            //    case FormType.Table:
