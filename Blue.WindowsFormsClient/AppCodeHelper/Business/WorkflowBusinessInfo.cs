...
namespace Blue.WindowsFormsClient
{
    ...
    /// </summary>
    [Serializable]
    public class WorkflowBusinessInfo
    {
        #region 属性
        ...
        public WorkflowBusinessInfo(decimal businessId, string businessName, string businessIntro, WorkflowType workflowType, bool businessEnabled, DateTime initialTime, DateTime expiredTime,
