...
namespace Blue.WindowsFormsClient
{
    ...
    /// 组合表的下拉选择项操作类
    /// </summary>
    public class CombinedTableDropdownList : CombinedTreeDropdownBase, ITreeDropdownHandler
    {
        #region 契约属性
        ...
        public CombinedTableDropdownList(ICustomGroupContract customGroupContract, ICombinedTableContract combinedTableContract)
            : this(customGroupContract, combinedTableContract, decimal.MinValue)
        {
        ...
        public CombinedTableDropdownList(ICustomGroupContract customGroupContract, ICombinedTableContract combinedTableContract, decimal rootNodeId)
            : base(customGroupContract, combinedTableContract, decimal.MinValue, (byte)GroupType.CombinedTable, false)
        {
