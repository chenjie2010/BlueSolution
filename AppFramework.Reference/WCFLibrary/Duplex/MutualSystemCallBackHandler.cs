//-----------------------------------------------------------------------------------------
// 模块编号：
// 文件名: FlexibleSystemCallBackHandler.cs
// 描述: 回调处理类
// 作者：ChenJie 
// 编写日期：2018-08-15
// 版权所有 (C) 四川大学 2018
...
namespace AppFramework.Reference.WCFLibrary
{
    ...
    public class MutualSystemCallBackHandler : IMutualChannelCallBackContract
    {
        #region 私有变量
        ...
        public MutualSystemCallBackHandler(PopupMessageDelegate popupMessageDelegate)
        {
        ...
        public string HandleMessage(SystemMessage message)
        {
