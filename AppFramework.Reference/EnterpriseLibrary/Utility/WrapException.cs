...
{
    /// <summary>
    /// 创建一个包装异常的类，继承ApplicationException
    /// </summary>
    [Serializable]
    public class WrapException : Exception
    {
        ...
        public WrapException(string message, Exception exception)
        ...
        protected WrapException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
