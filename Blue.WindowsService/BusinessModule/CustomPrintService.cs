...
namespace Blue.WCFServices.BusinessModule
{
    ...
    public class CustomPrintService : CommonNodeServices, ICustomPrintContract
    {
        ...
        public void UpdateDataFields(decimal printId, IList<CustomPrintAndDataFieldInfo> customPrintAndDataFieldInfos)
        {
            customPrintHandler.UpdateDataFields(printId, customPrintAndDataFieldInfos);
        }
        ...
        /// <param name="printId"></param>
        /// <returns></returns>
        public IList<CommonNode> GetDataFields(decimal printId)
        {
            return customPrintHandler.GetDataFields(printId);
        }
