...
namespace Blue.CustomLibrary.EnterpriseLibrary
{
    ...
    public sealed class DataWarehouseHelper
    {
        ...
        /// <returns></returns>
        public static bool ContainsDataSourceCode(string dataSourceCode)
        {
            string description = UserEnumHelper.GetDescription(typeof(DataWarehouse));

            string[] codes = description.Split('|');
            int index = Array.IndexOf(codes, dataSourceCode);
        ...
        /// <param name="dataSourceCode"></param>
        /// <returns></returns>
        public static byte GetDataSourceIdByCode(string dataSourceCode)
        {
           string description = UserEnumHelper.GetDescription(typeof(DataWarehouse));
        ...
        /// <returns></returns>
        public static byte GetDataSourceId(string dataSourceName)
        {
