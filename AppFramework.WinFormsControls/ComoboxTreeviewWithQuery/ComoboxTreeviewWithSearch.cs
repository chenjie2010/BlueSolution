...
namespace AppFramework.WinFormsControls
{
    ...
    public partial class ComoboxTreeviewWithSearch : UserControl
    {
        ...
        public TreeNode SelectedNode
        {
            ...
            get
            {
                if (string.IsNullOrWhiteSpace(popupContainerEdit.Text) && treeView.SelectedNode != null)
                {
                    popupContainerEdit.Text = treeView.SelectedNode.Text;
                }
        ...
        private void sbtnRemove_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                popupContainerEdit.EditValue = string.Empty;
            }
        ...
        /// <summary>
        /// 在初始化过程中，节点的编号为空(decimal.MinValue表示为空)节点加载为第一级节点
        /// </summary>
        /// <param name="commonNodes"></param>
        public void InitFullTreeNodes(IList<CommonNode> commonNodes)
        {
            InitFullTreeNodes(decimal.MinValue, commonNodes);
        }

        /// <summary>
        /// 完全加载树形结构，并将默认节点的数据赋值给相应的控件
        /// </summary>
        /// <param name="rootId">根节点编号</param>
        /// <param name="commonNodes">子节点对象列表</param>
        public void InitFullTreeNodes(decimal rootId, IList<CommonNode> commonNodes)
        {
            ...
            {
                if (commonNode.ParentNodeId == rootId)
                {
                    TreeNode tn = new TreeNode { Text = commonNode.NodeName, Tag = commonNode };
                    treeView.Nodes.Add(tn);

                    /* 非叶子节点，则继续加载子节点 */
                    if (!commonNode.IsLeaf)
                    {
                        LoadFullChildTreeNodes(tn, commonNodes);
                    }
                }
            }
        }
        ...
        public void LoadFullChildTreeNodes(TreeNode tnParent, IList<CommonNode> commonNodes)
        {
        ...
        /// </summary>
        /// <param name="commonNodes"></param>
        public void InitOneLevelChildTreeNodes(IList<CommonNode> commonNodes)
        {
            foreach (CommonNode commonNode in commonNodes)
            {
                TreeNode tn = new TreeNode { Text = commonNode.NodeName, Tag = commonNode };
        ...
        public void ClearSelectedNodes(TreeNodeCollection tnc)
        {
        ...
        private void treeView_AfterCheck(object sender, TreeViewEventArgs e)
        {
            ...
            popupContainerEdit.EditValue = sb.ToString();
        ...
        private void SetSelectedNode(TreeNodeCollection tnc, decimal selectedNodeId)
        {
            ...
            {
                CommonNode commonNodeTag = tn.Tag as CommonNode;                               
                if (commonNodeTag.NodeId == selectedNodeId)
                {
                    treeView.SelectedNode = tn;
                    SetEditFromTree();
                    break;
        ...
        private void SetEditFromTree()
        {
            ...
            {
                popupContainerEdit.EditValue = treeView.SelectedNode.Text ?? string.Empty;
                if (popupContainerEdit.EditValue != null)
                {
                    popupContainerEdit.ToolTip = popupContainerEdit.EditValue.ToString();
                }
            }
        }
