...
{
    public partial class DevExpressUploadFile : UserControl
    {
        #region 静态私有变量
        ...
        private event EventHandler<EventArgs> _OnViewLinkClicked;
        ...
        public event EventHandler<EventArgs> OnViewLinkClicked
        {
            add
            {
        ...
        /// </summary>
        /// <param name="e"></param>
        private void ViewLinkClicked(EventArgs e)
        {
            ...
            set
            {
                switch (value)
                {
                    ...
                    case DocType.DocAttachment:
                        ...
                        PeekFormButton peekFormButton = (PeekFormButton)fpFileOperation.OptionsButtonPanel.Buttons[0];
                        peekFormButton.Visible = false;
                        break;
                }
                _docType = value;
            }
        ...
        public bool ReadOnly
        {
            set
            {
                ...
                /* 删除 */
                DevExpress.Utils.PeekFormButton peekFormButton = (DevExpress.Utils.PeekFormButton)fpFileOperation.OptionsButtonPanel.Buttons[2];
                peekFormButton.Enabled = !value;
       ...
       Browsable(false),
        ...
        private void DevExpressUploadFile_Load(object sender, EventArgs e)
        {
            if (hlnkView.Visible)
            {
                imageEdit.Width = this.Width - 60;
                textEdit.Width = this.Width - 60;
                hlnkView.Location = new Point(this.Width - 30, 3);
        ...
        {
            ViewLinkClicked(e);
            if (fpFileOperation.FlyoutPanelState.IsActive)
            {
                return;
            }
            fpFileOperation.ShowBeakForm();            
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void fpFileOperation_ButtonClick(object sender, DevExpress.Utils.FlyoutPanelButtonClickEventArgs e)
        {
            byte button = Convert.ToByte(e.Button.Tag);
            switch (button)
            {
                case 0:
                    /* 查看*/
                    switch (_docType)
                    {
                        ...
                        case DocType.PDFAttachment:
                            ...
                            {
                                PDFViewerForm frmPDFViewer = new PDFViewerForm();
                                using (MemoryStream ms = new MemoryStream(_customData))
                                {
