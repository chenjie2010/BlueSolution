//-----------------------------------------------------------------------------------------
// 模块编号：
// 文件名: ICombinedTable.cs
// 描述: CombinedTable 数据访问层接口
// 作者：ChenJie 
// 编写日期：2018/8/15
// Copyright 2018
//-----------------------------------------------------------------------------------------
...
namespace Blue.IDAL.BusinessModule
{
    ...
    /// CombinedTable 接口
    /// </summary>
    public interface ICombinedTable : ICommonNode, IPrincipalTable<CombinedTableInfo>
    {
        #region 接口
        ...
        /// <param name="instanceId"></param>
        /// <returns></returns>
        Dictionary<decimal, DataTable> GetDataFilledData(decimal combinedTableId, bool businessEnabled, Dictionary<string, CommonDataFieldInfo> dataFieldNameRelations, decimal userId, decimal instanceId);
        ...
        /// <param name="combinedTableId"></param>
        /// <returns></returns>
        byte GetDataWarehouseId(decimal combinedTableId);
