...
{
    public interface IDataBussiness
    {
        /// <summary>
        /// 根据表的编号查看未填数据的用户
        /// </summary>
        ...
        void DeleteUploadFiles(string dataFieldName, string fileName);
        ...
        /// <param name="fileName"></param>
        void CopyUploadFiles(string sourceDataFieldName, string destDataFieldName, string fileName);
