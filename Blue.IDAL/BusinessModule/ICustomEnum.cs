...
namespace Blue.IDAL.BusinessModule
{
    ...
    /// CustomEnum 接口
    /// </summary>
    public interface ICustomEnum : ICommonNode, IPrincipalTable<CustomEnumInfo>
    {
        #region 接口
        ...
        /// <param name="enumName"></param>
        /// <returns></returns>
        CommonNode GetCommonNode(string parentEnumCode, string enumName);
        ...
        /// <param name="enumName"></param>
        /// <returns></returns>
        decimal GetEnumId(string parentEnumCode, string enumName);
        ...
        /// <param name="enumId"></param>
        /// <returns></returns>
        string GetEnumCode(decimal enumId);
