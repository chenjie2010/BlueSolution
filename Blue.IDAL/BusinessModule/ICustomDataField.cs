//-----------------------------------------------------------------------------------------
// 模块编号：
// 文件名：ICustomDataField.cs
// 描述：CustomDataField 数据访问层接口
// 作者：ChenJie 
// 编写日期：2016/9/11
// Copyright 2016
//-----------------------------------------------------------------------------------------
...
namespace Blue.IDAL.BusinessModule
{
    ...
    /// CustomDataField 接口
    /// </summary>
    public interface ICustomDataField : ICommonNode, IPrincipalTable<CustomDataFieldInfo>
    {
        #region 接口
        ...
        /// <returns></returns>
        IList<CommonNode> GetCommonNodesByEnumId(decimal enumId);
        ...
        /// <returns></returns>
        IList<CustomDataFieldInfo> GetModelsByAssociatedDataFieldId(decimal associatedDataFieldId);
        ...
        /// <returns></returns>
        CommonNode GetCommonNode(string physicalName);
        ...
        /// <param name="dataFieldId"></param>
        /// <returns></returns>
        decimal GetEnumId(decimal dataFieldId);
        ...
        /// <param name="dataFieldId"></param>
        /// <returns></returns>
        decimal GetParentDataFieldId(decimal dataFieldId);
        ...
        /// <returns> 字段的物理名称</returns>
        string GetLogicalName(string physicalName);
