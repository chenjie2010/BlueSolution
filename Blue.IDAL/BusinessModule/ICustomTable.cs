...
namespace Blue.IDAL.BusinessModule
{
    ...
    /// CustomTable 接口
    /// </summary>
    public interface ICustomTable : ICommonNode, IPrincipalTable<CustomTableInfo>
    {
        #region 接口
        ...
        Int64 GetTableSetting(decimal tableId);
        ...
        /// <returns></returns>
        object GetDataFiledValue(decimal userId, decimal dataFieldId);
        ...
        /// <param name="dataFieldId"></param>
        /// <returns></returns>
        object GetDataFiledValueByRecordId(decimal recordId, decimal dataFieldId);
        ...
        ///<param name="tableName">物理表名</param>
        /// <returns> 物理表名</returns>
        decimal GetTableId(string tableName);
