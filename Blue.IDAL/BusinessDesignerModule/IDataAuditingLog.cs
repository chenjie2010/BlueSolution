//-----------------------------------------------------------------------------------------
// 模块编号：
// 文件名: IDataAuditingLog.cs
// 描述: DataAuditingLog 数据访问层接口
// 作者：ChenJie 
// 编写日期：2018/9/28
// Copyright 2018
//-----------------------------------------------------------------------------------------
...
namespace Blue.IDAL.BusinessDesignerModule
{
    ...
    /// DataAuditingLog 接口
    /// </summary>
    public interface IDataAuditingLog : IPrincipalTable<DataAuditingLogInfo>
    {
        #region 接口
        ...
        /// <returns></returns>
        Dictionary<byte, int> GetStaticsByAuditingStatus(IList<WhereConditon> whereConditons);
