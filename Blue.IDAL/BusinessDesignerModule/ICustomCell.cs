...
namespace Blue.IDAL.BusinessDesignerModule
{
    ...
    /// CustomCell 接口
    /// </summary>
    public interface ICustomCell : IPrincipalTable<CustomCellInfo>
    {
        #region 接口
        ...
        /// <param name="relatedDepartmentCommonNodes"></param>
        /// <returns></returns>
        string GetRowCellStatiscsText(decimal cellId, byte dataWarehouseId, IList<WhereConditon> whereConditons, IList<CommonNode> relatedUserTypeCommonNodes, IList<CommonNode> relatedDepartmentCommonNodes);
