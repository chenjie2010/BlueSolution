...
namespace Blue.IDAL.UserModule
{
    ...
    /// UserAccount 接口
    /// </summary>
    public interface IUserAccount : IPrincipalTable<UserAccountInfo>
    {
        #region 接口
        ...
        void Update(string userName, string emailAddress, string telephoneNumber, byte[] imageData, string photoSuffixName);
        ...
        /// <returns> UserAccountInfo 对象</returns>
        UserAccountInfo GetModeInfoByUserIdentity(string userIdentity);
        ...
        bool ValidateUser(string userName, string password, ValidationMode userValidationType);
